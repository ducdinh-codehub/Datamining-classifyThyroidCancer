...
test_model = "inceptionv2" # model name
...
print("Number layers of " + test_model, len(InceptionResnetV2_model.layers))
...
modelPath = './modelStorage/inceptionresnetv2/'
modelFolder = 'Dec-21-2021-08-54-51' + '/'
modelName = "weights-improvement-42-0.43.hdf5"
