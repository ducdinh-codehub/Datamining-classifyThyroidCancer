...
test_model = "mobilenet" # model name
...
print("Number layers of " + test_model, len(mobilenet_model.layers))
...
modelPath = './modelStorage/mobilenet/'
modelFolder = 'Dec-21-2021-17-50-09' + '/'
modelName = "weights-improvement-26-0.43.hdf5"
