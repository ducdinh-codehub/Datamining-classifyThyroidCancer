...
folder_path = "./modelStorage/resnet/" + folder_name + "/"
...
modelName = 'weights-improvement-52-0.44.hdf5'
start_epoch = int(modelName.split("-")[2])
total_epoch = start_epoch + 20
transfer_model.load_weights('./modelStorage/resnet/Dec-20-2021-22-22-41/' + modelName)
history = transfer_model.fit(train_it, 
                            epochs = total_epoch, 
                            steps_per_epoch = train_it.samples/batchSize,
                            validation_data = test_it,
