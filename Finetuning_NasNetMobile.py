...
folder_path = "./modelStorage/nasnet/" + folder_name + "/"
...
modelName = 'weights-improvement-15-0.43.hdf5'
start_epoch = int(modelName.split("-")[2])
total_epoch = start_epoch + 20
transfer_model.load_weights('./modelStorage/nasnet/Dec-21-2021-16-12-19/' + modelName)
