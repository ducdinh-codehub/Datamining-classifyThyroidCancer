...
train_it = train_datagen.flow_from_directory('./train_generator/', class_mode='categorical', target_size = (224, 224), batch_size = batchSize)

test_datagen = ImageDataGenerator(preprocessing_function = preprocess_input)
test_it = test_datagen.flow_from_directory('./val_generator/', class_mode='categorical', target_size = (224, 224), batch_size = batchSize)
...
folder_path = "./modelStorage/densenet201/" + folder_name + "/"
...
'''
# Fine tuning my pretrained model
modelName = 'weights-improvement-42-0.41.hdf5'
start_epoch = int(modelName.split("-")[2])
total_epoch = start_epoch + 20
transfer_model.load_weights('./modelStorage/densenet201/Dec-21-2021-11-59-49/' + modelName)
history = transfer_model.fit(train_it, 
                            epochs = total_epoch, 
                            steps_per_epoch = train_it.samples/batchSize,
                            validation_data = test_it,
