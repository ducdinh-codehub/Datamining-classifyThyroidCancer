...
test_model = "xception" # model name
...
print("Number layers of ResNet50", len(xception_model.layers))
...
modelPath = './modelStorage/xception/'
modelFolder = 'Dec-21-2021-00-23-08' + '/'
modelName = "weights-improvement-26-0.44.hdf5"
