...
test_model = "vgg16" # model name

num_classes = 3

# Load data
print("Vgg16 loading information")
...
print("Vgg16 load pretrained model")
from tensorflow.keras.applications import VGG16
vgg16_model = VGG16(weights = 'imagenet', include_top = False, input_shape = (200, 200, 3))
print("Number layers of VGG16", len(vgg16_model.layers))

print("Vgg16 remove some layers")
for layer in vgg16_model.layers:
    layer.trainable = False

# Added new layers
print("Vgg16 adding some layers")
...
# Load weight
print("Vgg16 loading model name")
modelPath = './modelStorage/vgg16/'
modelFolder = 'Dec-20-2021-16-40-12' + '/'
