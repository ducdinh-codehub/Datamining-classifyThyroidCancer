...
folder_path = "./modelStorage/resnet152/" + folder_name + "/"
...
print("Finetuning my model")
modelName = 'weights-improvement-23-0.42.hdf5'
start_epoch = int(modelName.split("-")[2])
total_epoch = start_epoch + 20
transfer_model.load_weights('./modelStorage/resnet152/Dec-22-2021-17-12-10/' + modelName)
history = transfer_model.fit(train_it, 
                            epochs = total_epoch, 
                            steps_per_epoch = train_it.samples/batchSize,
                            validation_data = test_it,
