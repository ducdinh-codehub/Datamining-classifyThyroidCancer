...
test_model = "nasnetlarge" # model name
...
test_it = test_datagen.flow_from_directory(data_directory, class_mode='categorical', target_size = (331, 331), batch_size = 32)
...
print("Number layers of " + test_model, len(nasnet_model.layers))
...
modelPath = './modelStorage/nasnetlarge/'
modelFolder = 'Dec-22-2021-11-54-31' + '/'
modelName = "weights-improvement-32-0.42.hdf5"
